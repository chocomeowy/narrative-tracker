# Tax Intelligence Briefing - 2026-05-15 04:03

{
  "executive_briefing": "The global tax landscape in May 2026 continues its rapid evolution, particularly concerning corporate taxation and international trade. The OECD's Pillar Two global minimum corporate tax, set at 15% for large multinational groups, is now firmly embedded across over 140 jurisdictions, with the US-specific 'side-by-side arrangement' clarifying its unique position. This reform introduces new top-up taxes and compliance requirements. Trade policy remains highly dynamic, marked by ongoing US tariff actions, including confirmed IEEPA tariff refunds, invalidation challenges for Section 122 tariffs, an active appeal of a 10% global tariff, and new pharmaceutical tariffs, with the US Supreme Court expected to rule on the legality of IEEPA tariffs. Independently, various countries are adjusting their corporate tax rates for 2026, encompassing both increases and decreases, alongside a significant proposal by President Biden to hike the US federal corporate tax rate to 28%. Singapore continues to lead ASEAN with its stable 17% corporate tax rate, enhanced by specific rebates and exemptions, and its proactive digital tax transformation, notably its established multiyear InvoiceNow e-invoicing mandate for all GST-registered businesses. This mandate exemplifies the intensifying global push for digital tax compliance and efficiency, with e-invoicing seen as a standardized method for structured data exchange, improving compliance and payment cycles for consumption taxes like GST/VAT. Concurrently, mandatory Corporate Social Responsibility (CSR) and ESG reporting are becoming more prevalent, introducing new dimensions of corporate accountability and driving a shift towards integrated, sustainable business practices.",
  "trends": [
    {
    ...
    },
    {
      ...
      "velocity": "High",
      "category": "Tariffs",
      "summary": "The US continues active implementation and consideration of new tariffs, causing significant global trade disruptions, amidst increasing legal challenges. IEEPA tariffs are being refunded following a Supreme Court decision, and new Section 122 tariffs face a court ruling of insufficient justification, with an expected end by July 2026. Significant updates in April 2026 to Section 232 measures for key metals and new pharmaceutical import tariffs, alongside specific reciprocal tariff actions (including 10% baseline tariffs), underscore the dynamic and volatile nature of global trade policy. The Trump administration's appeal on a 10% global tariff imposed in February remains pending, with the US Supreme Court expected to rule on the legality of IEEPA tariffs.",
    ...
    },
    {
      ...
      "summary": "Singapore's nationwide InvoiceNow initiative, confirmed as a multiyear government-driven mandate in March 2026, requires structured invoice data submission to IRAS for certain GST-registered businesses, with phased deadlines expanding participation to existing businesses. Built on the global Peppol framework and the Peppol PINT SG standard, this initiative mandates B2B and B2G e-invoicing, streamlining payment cycles, improving efficiency through verification and validation, and setting a regional precedent for digital document exchange. Subsidies are available to aid preparation.",
