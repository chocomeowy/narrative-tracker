# Tax Intelligence Briefing - 2026-05-14 04:03

{
  "executive_briefing": "The global tax environment in May 2026 continues to be shaped by the widespread implementation of the OECD's Pillar Two global minimum corporate tax across over 140 jurisdictions, with the US managing this through its clarified 'side-by-side exception' for MNEs. Trade policy remains highly dynamic and contentious, marked by ongoing US tariff actions, including significant April 2026 updates to Section 232 metals and new pharmaceutical tariffs, alongside continuous legal challenges and the ongoing process of IEEPA tariff refunds. Domestically, US state-level corporate tax rates exhibit considerable volatility. Singapore maintains its leadership in ASEAN with a stable and competitive 17% corporate tax rate, bolstered by various incentives, and its pioneering InvoiceNow e-invoicing mandate is now firmly established as a multiyear requirement for GST-registered businesses, serving as a regional benchmark for digital compliance. This broader global push for digital tax transformation, encompassing e-invoicing and GST/VAT compliance, is intensifying to improve efficiency and compliance. Additionally, the accelerating global shift towards mandatory Corporate Social Responsibility (CSR) and ESG reporting introduces new layers of corporate accountability that businesses must navigate.",
  "trends": [
    {
