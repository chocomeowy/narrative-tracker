# Tax Intelligence Briefing - 2026-05-01 16:03

## Intelligence Map Update - May 1, 2026

**Executive Briefing:**

The global tax landscape continues to evolve rapidly, driven by the implementation of Pillar Two, escalating trade tensions, and the ongoing digital transformation of tax administration. The OECD's global minimum tax is solidifying, with the US securing a side-by-side arrangement allowing it to apply its own minimum taxes to US-headquartered companies. This development underscores the complex interplay between international agreements and national sovereignty. Simultaneously, the resurgence of trade tariffs, particularly from the US, is creating significant disruption and legal challenges. Several countries are adjusting corporate income tax rates, influenced by both competitive pressures and Pillar Two considerations. Singapore remains a key focus, with its e-invoicing initiative (InvoiceNow) expanding and its competitive corporate tax regime continuing to attract foreign investment. The ASEAN region presents a diverse tax environment, requiring nuanced strategies for multinational enterprises. Finally, understanding the implications of GST/VAT remains crucial for international corporate transactions. The overall trend indicates a more complex and dynamic tax environment demanding proactive adaptation from businesses.
  ...
  "trends": [
    {
      ...
      "summary": "The OECD's Pillar Two establishes a 15% global minimum corporate tax rate for large MNEs, impacting tax planning and potentially increasing tax revenue. The US has secured a side-by-side arrangement.",
    ...
    },
    {
      ...
      "velocity": "High",
      "category": "Tariffs",
      "summary": "The US is actively implementing and considering tariffs on goods, creating disruptions to global trade. The legality of these tariffs is being challenged, with refunds expected by May 11th.",
      "evidence": "New tariffs have been imposed on various goods. The U.S. Supreme Court is expected to rule on the legality of tariffs imposed under the IEEPA. Tariff refunds are being issued.",
      "source_links": [
    ...
    },
    {
      ...
      "evidence": "Portugal is decreasing its corporate income tax by 1% per year from 2026-2028. Slovenia temporarily increased its rate. Austria is planning to eliminate its highest tax bracket in 2026.",
      "source_links": [
        ...
        "https://taxfoundation.org/data/all/global/corporate-tax-rates-by-country-2025/",
        "https://www.grantthornton.com/insights/alerts/tax/2026/international-tax-planning-guide"
      ],
      "confidence": 0.9
    },
    {
