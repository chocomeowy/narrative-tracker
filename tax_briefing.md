# Tax Intelligence Briefing - 2026-05-04 22:03

## Intelligence Map Update - May 4, 2026

**Executive Briefing:**

The global tax landscape continues to be reshaped by the ongoing implementation of Pillar Two and escalating trade tensions, particularly those initiated by the US. The US divergence from OECD multilateral agreements, adopting a side-by-side approach to Pillar Two and aggressively pursuing new tariffs, introduces significant uncertainty for multinational enterprises. Corporate tax rate adjustments are occurring globally, with Singapore maintaining a competitive edge. The expansion of Singapore’s e-invoicing initiative, transitioning to Peppol PINT SG, represents a leading example of digital tax transformation. Heightened tariff enforcement and potential escalation, coupled with a strengthening global minimum tax regime, demand proactive tax planning and compliance strategies. Businesses must prioritize understanding these shifts to mitigate risks and capitalize on opportunities, particularly regarding global minimum tax calculations, tariff impact assessments, and digital tax compliance. The interplay between these factors necessitates a dynamic and adaptable approach to international tax strategy.
  ...
  "trends": [
    {
      ...
      "summary": "The OECD's Pillar Two establishes a 15% global minimum corporate tax rate for large MNEs, impacting tax planning and potentially increasing tax revenue. Implementation is progressing globally, with over 140 jurisdictions enforcing the rules.",
    ...
    },
    {
      ...
      "velocity": "High",
      "category": "Tariffs",
      "summary": "The US is actively implementing and considering tariffs on goods, creating disruptions to global trade. The legality of these tariffs is being challenged, with potential rulings impacting their validity.",
      "evidence": "New tariffs have been imposed on various goods. The U.S. Supreme Court is expected to rule on the legality of tariffs imposed under the IEEPA. Tariff refunds are being issued. Tariffs are being applied to metals, pharmaceuticals, and goods from Canada and Mexico.",
      "source_links": [
        ...
        "https://www.globalsources.com/knowledge/tariffs-update-impacts-and-negotiations/"
      ],
      "confidence": 0.95
    },
    {
      "name": "Singapore E-invoicing (InvoiceNow/Peppol)",
      "stage": "Breakthrough",
      "velocity": "Medium",
      "category": "International",
      "summary": "Singapore's nationwide e-invoicing initiative, InvoiceNow, is expanding to include GST-registered businesses and transitioning to Peppol PINT SG, becoming a core component of its digital tax transformation.",
    ...
    },
    {
      ...
      "source_links": [
        ...
        "https://www.singaporesecretaryservices.com/singapore-corporate-tax-2026-rates-exemptions-filing-guide-2/",
    ...
    },
    {
      ...
      "velocity": "Medium",
      "category": "International",
      "summary": "The ASEAN region presents a diverse corporate tax landscape, with varying rates and approaches, impacting investment decisions. Singapore has the lowest rate at 17%.",
